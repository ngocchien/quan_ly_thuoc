...
$worker->addFunction($jobConfiguration['function']['admin_mail'], 'adxReduceFn');
...
function adxReduceFn($job)
{
    ...
    $fileNameSuccess = "Worker_Admin_Send_Mail_Action";
    $fileNameError = "Worker_Admin_Send_Mail_Error";
    $arrData = array();
