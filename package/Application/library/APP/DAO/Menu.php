...
{
    const TABLE_NAME  = 'tbl_menu';
    const PRIMARY_KEY = 'menu_id';
    ...
    public static function buildWhere($params){
        ...
        if(!empty($params['menu_id'])){
            $strWhere .= ' AND menu_id = '. $params['menu_id'];
        }
        ...
        if(!empty($params['not_menu_id'])){
            $strWhere .= ' AND menu_id != '. $params['not_menu_id'];
        }

        if(!empty($params['menu_name'])){
            $strWhere .= ' AND menu_name = "'.$params['menu_name'] . '"';
        }
        ...
        if(!empty($params['search'])){
            ...
            if(is_numeric($params['search'])){
                $strWhere .= ' AND menu_id = '.$params['search'];
            }else{
                $strWhere .= ' AND (menu_name like "%'.$params['search'].'%")';
            }
