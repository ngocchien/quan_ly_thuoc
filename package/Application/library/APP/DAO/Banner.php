...
class Banner extends AbstractDAO
{
    const TABLE_NAME  = 'tbl_banner';
    const PRIMARY_KEY = 'banner_id';
    ...
    public static function buildWhere($params){
        ...
        if(!empty($params['banner_id'])){
            $strWhere .= ' AND banner_id = '. $params['banner_id'];
        }

        if(!empty($params['not_banner_id'])){
            $strWhere .= ' AND banner_id != '. $params['not_banner_id'];
        }

        if(!empty($params['banner_name'])){
            $strWhere .= ' AND banner_name = "'.$params['banner_name'] . '"';
        }
        ...
        if(!empty($params['search'])){
            ...
            if(is_numeric($params['search'])){
                $strWhere .= ' AND banner_id = '.$params['search'];
            }else{
